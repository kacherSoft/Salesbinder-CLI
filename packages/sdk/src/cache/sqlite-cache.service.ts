...
export class SQLiteCacheService implements CacheService {
  ...
  private initializeSchema(): void {
    ...
    this.ensureAvailabilitySourceColumns();
  }
  ...
  private ensureAvailabilitySourceColumns(): void {
    this.addColumnsIfMissing('items', [['quantity_available_source', 'TEXT NULL']]);
    this.addColumnsIfMissing('item_stock_locations', [['quantity_available_source', 'TEXT NULL']]);
  }
